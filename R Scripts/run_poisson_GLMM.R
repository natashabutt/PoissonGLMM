...
#bugs.data(datalist, dir = getwd(), digits = 5, data.file = "BUGS Models/Model 4.1/data.txt")
...
#bugs.data(inits(), dir = getwd(), digits = 5, data.file = "BUGS Models/Model 4.1/inits.txt")

parameters <- c("alpha","mu","sigma_b","sigma_e")

num_iter = 2000000

model_4.1 <- bugs(model.file= "D:/PoissonGLMM/BUGS Models/Model 4.1/Poisson_GLMM.odc",
                     data = datalist,
...
write.csv(gelman.diag(with_burn)[1],paste('BUGS Models/Model 4.1/',as.integer(num_iter),'/rhat.csv',sep=""))
write.csv(HPDinterval(with_burn,prob=0.95)[1],paste('BUGS Models/Model 4.1/',as.integer(num_iter),'/hpd.csv',sep=""))
write.csv(summary(with_burn)$statistics,paste('BUGS Models/Model 4.1/',as.integer(num_iter),'/summary.csv',sep=""))
write.csv(effectiveSize(with_burn),paste('BUGS Models/Model 4.1/',as.integer(num_iter),'/neff.csv',sep=""))

jpeg(paste("BUGS Models/Model 4.1/",as.integer(num_iter),"/alpha.jpg",sep=''), width = 450, height = 180)
...
jpeg(paste("BUGS Models/Model 4.1/",as.integer(num_iter),"/mu_1.jpg",sep=''), width = 450, height = 180)
par(mfrow=c(1,2),oma = c(0, 0, 2, 0),mar=c(4,3,1,2))
...
jpeg(paste("BUGS Models/Model 4.1/",as.integer(num_iter),"/mu_2.jpg",sep=''), width = 450, height = 180)
par(mfrow=c(1,2),oma = c(0, 0, 2, 0),mar=c(4,3,1,2))
...
jpeg(paste("BUGS Models/Model 4.1/",as.integer(num_iter),"/mu_3.jpg",sep=''), width = 450, height = 180)
par(mfrow=c(1,2),oma = c(0, 0, 2, 0),mar=c(4,3,1,2))
...
jpeg(paste("BUGS Models/Model 4.1/",as.integer(num_iter),"/sigma_b.jpg",sep=''), width = 450, height = 180)
par(mfrow=c(1,2),oma = c(0, 0, 2, 0),mar=c(4,3,1,2))
...
jpeg(paste("BUGS Models/Model 4.1/",as.integer(num_iter),"/sigma_e.jpg",sep=''), width = 450, height = 180)
par(mfrow=c(1,2),oma = c(0, 0, 2, 0),mar=c(4,3,1,2))
